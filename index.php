      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3">
          <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
            ...
            <span class="d-none d-md-block dropdown-toggle ps-2"><!-- username--><?php echo $_SESSION['username']; ?></span>
          </a>
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="supply-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="./approvisionnement/supply.php">
              <i class="bi bi-circle"></i><span>supply management</span>
            </a>
          </li>
          <li>
            <a href="./approvisionnement/addsupply.php">
