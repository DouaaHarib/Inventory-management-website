...
?>
 ...
 if(isset($_GET['submit'])){
    ...
    $dao->modifierclient($amodifier['0'],$name,$tele,
    $email,$address);
...
<div class="card-body">
    ...
    <form class="row g-3" action="formModification.php" method="get" >
                <div class="col-12">
                  <label for="inputNanme4" class="form-label">id client</label>
                  <input type="text" class="form-control" id="inputNanme4" name="idcli" value="<?php echo $amodifier['0']; ?>">
                </div>
                <div class="col-12">
