  ...
  <main id="main" class="main">
    ...
    <section class="section">
        ...
        <tr>
            ...
            <td><?php  echo "<img src='{$product['7'] }'width='30%' height='30%' "; ?></td>
            <td>
            <a href="deleteproduct.php?reference=<?php echo $product[0]; ?>"><i class="bi-trash"></i></a>
            <a href="formModificationproduct.php?reference=<?php echo $product[0]; ?>"><i class="bi-pen"></i> </a>
