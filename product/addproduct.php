...
if(isset($_GET['submit'])){
  ...
  require"../DAO.php";
    $dao=new DAO();
    $dao->addproduct($reference,$libellé,$stock,$unitprice,$buyingprice,$sellprice,$Productcategory,$picture);
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">add productt</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
...
<div class="card-body">
    <h2>add product</h2>
    <form class="row g-3" action="addproduct.php" method="get" >
                <div class="col-12">
                ...
                <div class="col-12">
                  ...
                  <input type="text" class="form-control" id="inputEmail4" name="libellé" >
                </div>
                <div class="col-12">
                  <label for="inputPassword4" class="form-label">unit price</label>
                  <input type="text" class="form-control" id="inputPassword4" name="unitprice" >
                </div>
                <div class="col-12">
                  <label for="inputPassword4" class="form-label">stock</label>
                  <input type="text" class="form-control" id="inputPassword4" name="stock" >
                </div>
                <div class="col-12">
                  <label for="inputPassword4" class="form-label">buying price</label>
                  <input type="text" class="form-control" id="inputPassword4" name="buyingprice" >
                </div>
                <div class="col-12">
                  <label for="inputPassword4" class="form-label">sell price</label>
                  <input type="text" class="form-control" id="inputPassword4" name="sellprice">
                </div>
                <div class="col-12">
                  <label for="inputPassword4" class="form-label">Product category</label>
                  <input type="text" class="form-control" id="inputPassword4" name="Productcategory" >
                </div>
                <div></div>
                <div class="row mb-3">
