...
if(!isset($_SESSION['username'])){
 ...
 if(isset($_GET['numCatego'])){
    ...
    $amodifier=$dao->getcategorie($numCatego);
 ...
 if(isset($_GET['submit'])){
    ...
    $dao->modifiercategorie($amodifier['0'],$name,$nbProduct);
...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="providerManagement.php">categories</a></li>
...
<div class="card">
<div class="card-body">
    <h2>modify categorie</h2>
    <form class="row g-3" action="formModificationcategorie.php" method="get" >
                <div class="col-12">
                  <label for="inputNanme4" class="form-label">number of categorie</label>
                  <input type="text" class="form-control" id="inputNanme4" name="numCatego" value="<?php echo $amodifier['0']; ?>">
                </div>
                <div class="col-12">
                ...
                <div class="col-12">
                  <label for="inputPassword4" class="form-label">number of product</label>
                  <input type="text" class="form-control" id="inputPassword4" name="nbProduct" value="<?php echo $amodifier['2']; ?>">
                </div>
