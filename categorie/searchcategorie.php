     ...
     <section class="section">
        <div class="row">
          <div class="col-lg-12">
            ...
            <div class="card">
              <div class="card-body">
                <h5 class="card-title">categorie table</h5>  
                <table class="table datatable">
                  <thead>
                    <tr>  
                    <th scope="col"> number of categorie  </th>
        ...
        <tr>
            ...
            <td></td>
            <td>
            <a href="deletecategorie.php?numCatego=<?php echo $client[0]; ?>"><i class="bi-trash"></i></a>
            <a href="formModificationcategorie.php?numCatego=<?php echo $client[0]; ?>"><i class="bi-pen"></i> </a>
