...
if(isset($_GET['submit'])){
  ...
  require"../DAO.php";
    $dao=new DAO();
    $dao->addcategorie($numCatego,$name,$nbProduct);
...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="categorie.php">categories</a></li>
...
<div class="card-body">
    <h2>add categorie</h2>
    <form class="row g-3" action="addcategorie.php" method="get" >
                <div class="col-12">
                  <label for="inputNanme4" class="form-label">number of categorie</label>
                  <input type="text" class="form-control" id="inputNanme4" name="numCatego" >
                </div>
                <div class="col-12">
                ...
                <div class="col-12">
                  ...
                  <input type="text" class="form-control" id="inputPassword4" name="nbProduct" >
                </div>
