...
if(isset($_GET['submit'])){
  ...
  require"../DAO.php";
    $dao=new DAO();
    $dao->addprovider($numProvider,$name,$tele,$email,$address);
...
<div class="card-body">
    ...
    <form class="row g-3" action="addprovider.php" method="get" >
                <div class="col-12">
                  <label for="inputNanme4" class="form-label">number of provider</label>
                  <input type="text" class="form-control" id="inputNanme4" name="numProvider" >
                </div>
                <div class="col-12">
                ...
                <div class="col-12">
                  ...
                  <input type="tel" class="form-control" id="inputPassword4" name="tele" >
                </div>
                <div class="col-12">
