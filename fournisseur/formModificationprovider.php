...
if(!isset($_SESSION['username'])){
 ...
 if(isset($_GET['numProvider'])){
    ...
    $amodifier=$dao->getfournisseur($numProvider);
 ...
 if(isset($_GET['submit'])){
    ...
    $dao->modifierfournisseur($amodifier['0'],$name,$tele,
    $email,$address);
...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="providerManagement.php">provider</a></li>
          <li class="breadcrumb-item active">provider management</li>
...
<div class="card">
<div class="card-body">
    <h2>modify a provider</h2>
    <form class="row g-3" action="formModificationprovider.php" method="get" >
                <div class="col-12">
                  <label for="inputNanme4" class="form-label">id client</label>
                  <input type="text" class="form-control" id="inputNanme4" name="numProvider" value="<?php echo $amodifier['0']; ?>">
                </div>
                <div class="col-12">
                  <label for="inputEmail4" class="form-label">name</label>
                  <input type="text" class="form-control" id="inputEmail4" name="name" value="<?php echo $amodifier['1']; ?>">
                </div>
                <div class="col-12">
                  <label for="inputPassword4" class="form-label">tele</label>
                  <input type="tel" class="form-control" id="inputPassword4" name="tele" value="<?php echo $amodifier['2']; ?>">
                </div>
                <div class="col-12">
                  <label for="inputAddress" class="form-label">email</label>
                  <input type="email" class="form-control" id="inputAddress" name="email" value="<?php echo $amodifier['3']; ?>">
                </div>
                <div class="col-12">
                  <label for="inputAddress" class="form-label">Address</label>
                  <input type="text" class="form-control" id="inputAddress" name="address" value="<?php echo $amodifier['4']; ?>">
                </div>
