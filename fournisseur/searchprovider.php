    ...
    <section class="section">
        <div class="row">
          <div class="col-lg-12">
            ...
            <div class="card">
              <div class="card-body">
                <h5 class="card-title">provider table</h5>  
        ...
        <tr>
            ...
            <td>
            <a href="deleteprovider.php?numProvider=<?php echo $client[0]; ?>"><i class="bi-trash"></i></a>
            <a href="formModificationprovider.php?numProvider=<?php echo $client[0]; ?>"><i class="bi-pen"></i> </a>
