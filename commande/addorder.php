...
if(isset($_GET['submit'])){
  ...
  require"../DAO.php";
    $dao=new DAO();
    $dao->addcmd($numcmd,$date,$idcli,$reference,$quantite);
...
<div class="card-body">
    <h2>Add an order </h2>
    <form class="row g-3" action="addorder.php" method="get" >
                <div class="col-12">
                  <label for="inputNanme4" class="form-label">number of order</label>
                  <input type="text" class="form-control" id="inputNanme4" name="numcmd" >
                </div>
                <div class="col-12">
                  <label for="inputEmail4" class="form-label">date</label>
                  <input type="text" class="form-control" id="inputEmail4" name="date" >
                </div>
                <div class="col-12">
                  <label for="inputPassword4" class="form-label">id client</label>
                  <input type="text" class="form-control" id="inputPassword4" name="tele" >
                </div>
                <div class="col-12">
                  <label for="inputAddress" class="form-label">product reference</label>
                  <input type="reference" class="form-control" id="inputAddress" name="reference" >
                </div>
                <div class="col-12">
                  <label for="inputAddress" class="form-label">quantite</label>
                  <input type="text" class="form-control" id="inputAddress" name="quantite" >
                </div>
