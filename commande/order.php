...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="search-bar">
      <form class="search-form d-flex align-items-center" method="get" action="searchorder.php">
  ...
  <main id="main" class="main">
    ...
    <section class="section">
        ...
        ?>
        <tr>
            <td><?php echo $cmd['0']; ?></td>
            <td><?php echo $cmd['1']; ?></td>
            <td><?php echo $cmd['2']; ?></td>
            <td><?php echo $cmd['3']; ?></td>
            <td><?php echo $cmd['4']; ?></td>
            <td>
            <a href="deleteorder.php?numcmd=<?php echo $cmd[0]; ?>"><i class="bi-trash"></i></a>
            <a href="formModificationorder.php?numcmd=<?php echo $cmd[0]; ?>"><i class="bi-pen"></i> </a>
            <a href="pdf.php?numcmd=<?php echo $cmd[0]; ?>"><i class="bi-file-earmark-pdf"></i> </a>
