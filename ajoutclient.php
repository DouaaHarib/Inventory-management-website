...
if(isset($_GET['submit'])){
  ...
  require"DAO.php";
    $dao=new DAO();
    $dao->addclient($idcli,$name,$tele,$email,$address);
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active"><a href="ajoutclient.php">add customer</a></li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
...
<div class="card-body">
    ...
    <form class="row g-3" action="ajoutclient.php" method="get" >
                <div class="col-12">
                  <label for="inputNanme4" class="form-label">id client</label>
                  <input type="text" class="form-control" id="inputNanme4" name="idcli" >
                </div>
                <div class="col-12">
