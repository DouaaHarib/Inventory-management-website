    ...
    <section class="section">
        <div class="row">
          <div class="col-lg-12">
            ...
            <div class="card">
              <div class="card-body">
                <h5 class="card-title">supply table</h5>  
                <table class="table datatable">
                  <thead>
                    <tr>  
                      <th scope="col"> number of supply  </th>
                      <th scope="col">date</th>
                      <th scope="col">number of provider</th>
                      <th scope="col">reference of product</th>
        ...
        ?>
        <tr>
            <td><?php echo $supply['0']; ?></td>
            <td><?php echo $supply['1']; ?></td>
            <td><?php echo $supply['2']; ?></td>
            <td><?php echo $supply['3']; ?></td>
            <td><?php echo $supply['4']; ?></td>
            
            <td>
            <a href="deletesupply.php?numsupply=<?php echo $supply[0]; ?>"><i class="bi-trash"></i></a>
            <a href="formModificationsupply.php?numsupply=<?php echo $supply[0]; ?>"><i class="bi-pen"></i> </a>
