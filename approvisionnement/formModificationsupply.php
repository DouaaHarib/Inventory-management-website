...
if(!isset($_SESSION['username'])){
 ...
 if(isset($_GET['numsupply'])){
    ...
    $amodifier=$dao->getsupply($numsupply);
    
 }

 if(isset($_GET['submit'])){
    $datesupply=$_GET['datesupply'];
    $numprovider=$_GET['numprovider'];
    $reference=$_GET['reference'];
    $quantite=$_GET['quantite'];
    
    $dao->modifiersupply($amodifier['0'],$datesupply,$numprovider,$reference,$quantite);
...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="search-bar">
      <form class="search-form d-flex align-items-center" method="get" action="searchcategorie.php">
        <input type="text" name="q" placeholder="Search" title="Enter search keyword">
        <button type="submit" title="Search" name="searchcategorie"><i class="bi bi-search"></i></button>
      </form>
    </div><!-- End Search Bar -->
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <!-- End order Nav -->
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#supply-nav" data-bs-toggle="collapse" href="#">
          <i class="bi-cart"></i><span>supply</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="supply-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="supply.php">
              <i class="bi bi-circle"></i><span>supply management</span>
            </a>
          </li>
          <li>
            <a href="addsupply.php">
              <i class="bi bi-circle"></i><span>add suply</span>
            </a>
          </li>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="providerManagement.php">supply</a></li>
          <li class="breadcrumb-item active">supply management</li>
...
<div class="card-body">
    <h2>modify supply</h2>
    <form class="row g-3" action="formModificationsupply.php" method="get" >
                <div class="col-12">
                  <label for="inputNanme4" class="form-label">number of supply</label>
                  <input type="text" class="form-control" id="inputNanme4" name="numsupply" value="<?php echo $amodifier['0']; ?>">
                </div>
                <div class="col-12">
                  <label for="inputEmail4" class="form-label">date</label>
                  <input type="text" class="form-control" id="inputEmail4" name="datesupply" value="<?php echo $amodifier['1']; ?>">
                </div>
                <div class="col-12">
                  <label for="inputPassword4" class="form-label">number of provider</label>
                  <input type="text" class="form-control" id="inputPassword4" name="numprovider" value="<?php echo $amodifier['2']; ?>">
                </div>
                <div class="col-12">
                  <label for="inputPassword4" class="form-label">reference of product</label>
                  <input type="text" class="form-control" id="inputPassword4" name="reference" value="<?php echo $amodifier['3']; ?>">
                </div>
                <div class="col-12">
                  <label for="inputPassword4" class="form-label">quantite</label>
                  <input type="text" class="form-control" id="inputPassword4" name="quantite" value="<?php echo $amodifier['4']; ?>">
                </div>
