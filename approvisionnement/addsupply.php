...
if(isset($_GET['submit'])){
  ...
  require"../DAO.php";
    $dao=new DAO();
    $dao->addsupply( $numsupply,$datesupply,$numprovider,$reference,$quantite);
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">add supply</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    <!-- add supply form -->
...
<div class="card-body">
    <h2>Add supply</h2>
    <form class="row g-3" action="addsupply.php" method="get" >
                <div class="col-12">
                  <label for="inputNanme4" class="form-label">number of supply</label>
                  <input type="text" class="form-control" id="inputNanme4" name="numsupply" >
                </div>
                <div class="col-12">
                  <label for="inputEmail4" class="form-label">date</label>
                  <input type="text" class="form-control" id="inputEmail4" name="datesupply" >
                </div>
                <div class="col-12">
                  <label for="inputPassword4" class="form-label">number of provider</label>
                  <input type="text" class="form-control" id="inputPassword4" name="numprovider" >
                </div>
                <div class="col-12">
                ...
                <div class="col-12">
                  ...
                  <input type="text" class="form-control" id="inputPassword4" name="quantite" >
                </div>
